...
psi4_method_basis  = 'ccsd/aug-cc-pvdz'      # Method/Basis Set
...
R_i   = [1.2,   2.0,  6.0,  9.0, 15.0,  50.0] # initial R in Ang. (eg. 0.1 Ang.)
R_f   = [2.0,   6.0,  9.0, 15.0, 25.1, 100.1] # final R - R_stp (eg 1.95 Ang.)
R_stp = [0.05,  0.05,  0.2,  0.5,  1.0,  50.0] # step size for R_i-R_f
