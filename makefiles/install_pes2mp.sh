...
conda install -y keras-tuner pyshtools tensorflow tqdm numpy pandas pyarrow scipy sympy matplotlib scikit-learn jupyter spyder lmfit pydot python-graphviz -c conda-forge 
