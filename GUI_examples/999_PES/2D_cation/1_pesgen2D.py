...
RR1_atoms        = ['H', 'C', 'O'] # Enter rigid rotor (RR1) atoms from one end
RR1_bond_len     = [1.0972,1.1047]  # Enter bond lengths from the same end (see manual)
...
theta  = [0, 181, 5]    # python loop will run from 0 to 90 with step size of 30
...
R_i   = [2.0,  6.0,  9.0, 15.0,  50.0] # initial R in Ang. (eg. 0.1 Ang.)
...
R_lim = [2.5,5]      # Enter R limit [start,end] in Angstroms(Rough PES!)
