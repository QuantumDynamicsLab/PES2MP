...
It automatically creates PES input files for 4D i.e. rigid rotor - rigid rotor
collision.

RR_1 and RR_2 can have any number of atoms: E.g.

RR1_atoms     Mg------C---C-----C---C-----C--H    ['Mg','C','O','N','P','S','H']
RR_bond_len      1.8   1.0  1.2  1.0  1.5  0.8    [1.8, 1.0, 1.2, 1.1, 1.5, 0.8]

RR1_atoms                  H-----H                ['H','H']
RR_2_bond_len               0.741                 [ 0.741 ]
...
#------------------------------------------------------------------------------#
Proj_name        = 'pesgen4D' # Set a folder (Project) name
#------------------------------------------------------------------------------#
...
#RR1_bond_len     = [1.2425]  # Enter bond lengths from the same end (see above)
...
thetax             = [[0,0,0],[0,90,90],[90,90,90],[30,60,90]] # 1D Plot
# Angle combinations for Ploar plots
...
table,R,Phi,Theta2,Theta1,$E1,$E1,$E3
digits,2,2,2,2,10,10,10
