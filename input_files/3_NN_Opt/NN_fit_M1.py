...
train_dataset   = [85]*4       # % of data points used for training model
...
NN_hyperpara = {
    ...
    'maxit_trial' : 100,          # max iterations during trial (100-500)
    'maxit_base'  : 500,         # max iterations: base model (500-5000)
