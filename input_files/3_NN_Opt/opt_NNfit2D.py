...
ini_values = [1   ,  0]      # Initial values for each input dimension
fin_values = [50.1, 91]      # Final values for each input dimension
step_sizes = [0.1 , 15]      # Step sizes for each input dimension
#################################################################################
...
NN_hyperpara = {
    ...
    'NN_layers'   :     [4],      # search space for NN layers 
    'NN_branches' :     [4],        # search space for NN Branches: even only
...
#-------------------------------------------------------------------------------#
num_X = 2                     # the number of  input columns (descriptors)
...
reference_output = 2       # Column number for sorting and separating minima/HE
