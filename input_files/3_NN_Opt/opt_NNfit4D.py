...
train_dataset   = [90]*4      # % of data points used for training model
...
NN_hyperpara = {
    ...
    'NN_layers'   :      [8],          # search space for NN layers 
    'NN_branches' :      [4],          # search space for NN Branches: even only
    'maxit_trial' :       10,          # max iterations during trial (100-500)
    'maxit_base'  :    20000,          # max iterations: base model (500-5000)
    'maxit_ensemble' : 20000           # max iterations: ensemble model (5-10K)
}
