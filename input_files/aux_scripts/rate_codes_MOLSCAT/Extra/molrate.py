''' python file to get rates for single transition (For Debugging) ''' 
...
tmax = 500    # maximum temperature in kelvin
redm = 1.9354 # reduced mass in amu
si_n = 1      # skips sigma for every nth element (use for debugging purpose else keep 1)
